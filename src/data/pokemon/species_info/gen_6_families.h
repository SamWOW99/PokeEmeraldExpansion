...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                      \
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_FLOETTE_ ##FORM##_FLOWER},  \
                                 {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_FLOETTE_ETERNAL_FLOWER})
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FRISK, ABILITY_OWN_TEMPO, ABILITY_INFILTRATOR },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_MALE, 23, SPECIES_MEOWSTIC_MALE},
                                {EVO_LEVEL_FEMALE, 23, SPECIES_MEOWSTIC_FEMALE}),
    },
